...
export async function initializeDatabase() {
  try {
    ...
    const homelessnessTable = await database.createTable({
      name: "homelessness_table",
      columns: {
        ...
        homelessness_probability: { type: "FLOAT", nullable: true },
        // warriors_score: { type: "FLOAT", nullable: true },
        // cavaliers_score: { type: "FLOAT", nullable: true },
      },
    });

    console.log("Table created or already exists:", homelessnessTable);
    return homelessnessTable;
  } catch (error) {
